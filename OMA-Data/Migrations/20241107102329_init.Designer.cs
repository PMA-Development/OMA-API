...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OMA_Data.Models.Alarm", b =>
                {
            ...
            modelBuilder.Entity("OMA_Data.Models.AlarmConfig", b =>
                {
            ...
            modelBuilder.Entity("OMA_Data.Models.Attribute", b =>
                {
            ...
            modelBuilder.Entity("OMA_Data.Models.Drone", b =>
                {
            ...
            modelBuilder.Entity("OMA_Data.Models.Island", b =>
                {
            ...
            modelBuilder.Entity("OMA_Data.Models.Log", b =>
                {
            ...
            modelBuilder.Entity("OMA_Data.Models.Sensor", b =>
                {
                    b.Property<int>("SensorID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OMA_Data.Models.Task", b =>
                {
            ...
            modelBuilder.Entity("OMA_Data.Models.Turbine", b =>
                {
            ...
            modelBuilder.Entity("OMA_Data.Models.User", b =>
                {
            ...
            modelBuilder.Entity("OMA_Data.Models.Alarm", b =>
                {
                    b.HasOne("OMA_Data.Models.Island", "Island")
                        .WithMany()
                        .HasForeignKey("IslandFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("OMA_Data.Models.Turbine", "Turbine")
                        .WithMany()
            ...
            modelBuilder.Entity("OMA_Data.Models.Attribute", b =>
                {
                    b.HasOne("OMA_Data.Models.Sensor", null)
                        .WithMany("Attributes")
            ...
            modelBuilder.Entity("OMA_Data.Models.Drone", b =>
                {
                    b.HasOne("OMA_Data.Models.Task", "Task")
                        .WithMany()
            ...
            modelBuilder.Entity("OMA_Data.Models.Log", b =>
                {
                    b.HasOne("OMA_Data.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("OMA_Data.Models.Task", b =>
                {
                    b.HasOne("OMA_Data.Models.User", "Owner")
                        .WithMany()
            ...
            modelBuilder.Entity("OMA_Data.Models.Turbine", b =>
                {
                    b.HasOne("OMA_Data.Models.Sensor", "Sensor")
                        .WithMany()
